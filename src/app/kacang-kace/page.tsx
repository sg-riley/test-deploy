    ...
    <div className="min-h-screen bg-white overflow-hidden">
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center text-white">
          ...
          >
            <span className="text-sm font-medium animate-fade-in">UMKM</span>
            ...
            <p className="mt-4 text-lg md:text-xl text-white/80 max-w-xl mx-auto animate-fade-in-delay-2">
              Kacang Kace, camilan khas Desa Nyanglan yang terbuat dari kacang
              tanah pilihan yang digoreng dengan bumbu rempah khas Bali.
            </p>
          </div>
        </div>
      </section>
